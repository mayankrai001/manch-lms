  ...
  <nav class="fixed top-0 left-0 w-full bg-white shadow-md z-50">
      ...
      <div class="flex justify-between h-16">
        <div class="flex items-center">
          <router-link to="/" class="flex-shrink-0 flex items-center gap-2">
            ...
            <span class="font-bold text-xl text-primary-dark">Manch Classes</span>
          </router-link>
        </div>
        ...
        <div class="flex items-center md:hidden">
          <button @click="toggleMobileMenu" class="text-gray-600 hover:text-primary focus:outline-none">
    ...
    <div v-show="isMobileMenuOpen" class="md:hidden bg-white border-t">
      <div class="px-2 pt-2 pb-3 space-y-1 sm:px-3 flex flex-col">
        ...
        <router-link to="/admission" @click="closeMobileMenu"
